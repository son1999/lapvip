    ...
    <tr>
        <td align="center" valign="" style="padding:0;margin:0;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="640" style="border: 1px solid #DDDDDD;background: #FFF;padding:20px; border-bottom: 3px solid #ff9600">
                ...
                <tr>
                    <td colspan="2" style="color: #53a11b; font-size: 20px; padding: 10px 0">Đặt hàng thành công</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align: center"><a href="{{route('cart_complete',['token' => @$order->token_tracking])}}" style="color: #fff; background-color: #008aff; border-radius: 18px; line-height: 36px ; display: inline-block; margin: 25px auto 50px; padding: 0 25px; text-decoration: none">Xem chi tiết đơn hàng</a></td>
                </tr>
            </table>
        </td>
    </tr>
