                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        <div class="input-group">
                            ...
                            <input type="text" name="time_from" class="datepicker form-control" placeholder="Ngày từ" autocomplete="off" value="{{ $search_data->time_from }}">
                        </div>
                    </div>
                    <div class="form-group col-sm-4">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" name="time_to" class="datepicker form-control" placeholder="Ngày đến" autocomplete="off" value="{{ $search_data->time_to }}">
                        </div>
                    </div>
                </div>
            </div>
