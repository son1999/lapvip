                ...
                <div class="row">
                    <div class="form-group col-sm-4">
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Name" value="{{ $search_data->name }}">
                        </div>
                    </div>
                    <div class="form-group col-sm-4">
                        <div class="input-group">
            ...
            <div class="card-body">
                <table class="table table-bordered table-striped table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="wrap-img">
                                <img src="{{$item->getImageUrl('small')}}" alt="">
                            </div>
                        </td>
                        <td align="center" class="font-weight-bold">{{$item->name}}</td>
                        ...
                        <td align="center">
                            @if(\Lib::can($permission, 'edit'))
                                @if($item->status == 2)
                                    <a href="javascript:void(0)" class="text-primary" onclick="shop.admin.updateStatus({{ $item->id }},false,'supports')" title="Đang hiển thị, Click để ẩn"><i class="icon-eye icons"></i></a>
                                @else
                                    <a href="javascript:void(0)" class="text-secondary" onclick="shop.admin.updateStatus({{ $item->id }}, true,'supports')" title="Đang ẩn, Click để hiển thị"><i class="icon-eye icons"></i></a>
                                @endif
