                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('title_banner') ? ' is-invalid' : '' }}" id="title_banner" name="title_banner" value="{{ old('title_banner') }}" required>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('title_intro') ? ' is-invalid' : '' }}" id="title_intro" name="title_intro" value="{{ old('title_intro') }}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('description_intro') ? ' is-invalid' : '' }}" id="description_intro" name="description_intro" value="{{ old('description_intro') }}" required>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('title_store') ? ' is-invalid' : '' }}" id="title_store" name="title_store" value="{{ old('title_store') }}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input v-model="input"  type="text" class="form-control{{ $errors->has('title_product') ? ' is-invalid' : '' }}" id="title_product" name="title_product" value="{{ old('title_product') }}" required>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="title">Upload hình ảnh Slide</label>
