<div id="gallery-slide-vue">
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <input type="hidden" id="gallery-object_id_slide" value="{{@$object_id}}">
                <input type="hidden" id="img_upload_for_add_slide" name="img_upload_for_add_slide" value="{{ old('img_upload_for_add_slide') }}">
                <div>
                    <input type="file" name="uploadify_hotel_img_slide" id="uploadify_hotel_img_slide" />
                ...
                <ul v-if="showListSlide">
                    <li class="image-item" v-for="item in images" :data-id="item.id">
                        ...
                        <div class="actions">
                            ...
                            <a href="javascript:void(0)" @click="imageEdit(item)" title="Xem & Share" data-toggle="modal" data-target=".image-view-slide"><i class="fa fa-search"></i></a>
    ...
    <div class="modal fade image-view-slide" tabindex="-1" role="dialog">
...
@push('css_after_all')
    {!! \Lib::addMedia('admin/js/story_gallery/slide_story_gallery.css') !!}
@endpush

@push('js_bot_all')
    {!! \Lib::addMedia('admin/js/story_gallery/slide_story_gallery.upload.js') !!}
    ...
    {!! \Lib::addMedia('admin/js/story_gallery/slide_story_gallery.js') !!}
@endpush