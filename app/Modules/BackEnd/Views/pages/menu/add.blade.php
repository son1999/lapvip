        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-6 icon_type" id="4" style="{{old('type') == 4 ? '' : 'display: none'}}">
                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <select id="type_cate_footer" name="type_cate_footer" class="form-control{{ $errors->has('type_cate_footer') ? ' is-invalid' : '' }}" onchange="shop.getCatfooter(this.value, $('#lang').val())">
                                            <option value="-1">-- Chọn --</option>
                                            @foreach($type as $k => $v)
                                                <option value="{{ $k }}" @if(old('type_cate_footer') == $k) selected="selected" @endif>{{ $v }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-6 icon_type" id="3" style="{{old('type') == 3 ? '' : 'display: none'}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="id_selling" name="id_selling" placeholder="ID của sản phẩm, phân tách nhau bởi dấu phẩy (,)">
                                    </div>
                                </div>
                            </div>
                        </div>
