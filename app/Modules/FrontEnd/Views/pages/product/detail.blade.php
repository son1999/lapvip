        ...
        <div >
            <div class="product-wrapper" id="app_prd_detail">
                <section class="product-content">
                    <div class="product-content-heading">
                        ...
                        <div class="evaluate">
                            <p>@if(count($comment['comment']) > 0) {{count($comment['comment'])}} khách hàng đánh giá @endif @if($comment['count'] > 0)| {{$comment['count']}} câu hỏi được trả lời @endif</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="customize-product-slider">
                                <div class="collection js-carousel" data-items="1" data-dots="true" data-arrows="false" data-autoplay="true" dat >
                                    <div class="product-slide">
                                        <div class="product-image">
                                            <a data-fancybox="img-slide" class="item" href="{{\ImageURL::getImageUrl($data->image, 'products', 'original')}}">
                                        ...
                                        <div class="specifications">
                                            <div class="price">
                                                @if($data['out_of_stock'] == 0)
                                                    ...
                                                    @endif
                                                @else
                                                    <span class="price-discount text-danger">Liên hệ</span>
                                                @endif
                                            ...
                                            @if(!empty($data->product_relates))
                                                <div class="main-load-more" >
                                                    @foreach($data->product_relates as $key => $item_relates)
                                                        @if(!empty($item_relates->product))
                                                            <div class="configuration config-1 load">
                                                                <a href="{{route('product.detail', ['alias' => $item_relates->product->alias])}}">
                                                                    <div class="la-bel">
                                                                        <div class="ra-dio">
                                                                            <div class="checkmark">
                                                                                {{$item_relates->title}} <span class="text-danger font-weight-bold">@if($item_relates->out_of_stock == 0){{\Lib::priceFormatEdit($item_relates->product->price, '')['price']}} đ @else Liên hệ @endif</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </a>
                                                ...
                                                <div class="view-more text-center parent-btn-load"> <button class="btn-load-more">Xem thêm</button> </div>
                                            ...
                                            @if(!empty($data->sale_detail))
                                                <div class="policy">
                                                    {{--                                                <p>--}}
                                                    {{--                                                    Mua giá gốc : @if($data->priceStrike > 0)--}}
                                                    {{--                                                        {{\Lib::priceFormat($data->priceStrike)}}--}}
                                                    {{--                                                    @else--}}
                                                    {{--                                                        {{\Lib::priceFormat($data->price)}}--}}
                                                    {{--                                                    @endif--}}
                                                    {{--                                                    khách hàng được--}}
                                                    {{--                                                    chọn 1 trong 2 Khuyến mại sau:--}}
                                                    {{--                                                </p>--}}
                                                    @php($summary = explode("\n",$data->sale_detail))
                                                ...
                                                <div class="d-flex" >
                                                    <div class="color" v-for="filter in filters">
                                                        <label v-if="filter.filter_cate_id == cate.id">
                                                            ...
                                                            <span class="filter-title" v-if="filter.title.indexOf('#') == -1">@{{ filter.title }}</span>
                                            ...
                                            @if($data['out_of_stock'] == 0)
                                                ...
                                                <div class="buy-now">
                                                    <button class="btn btn-block" type="btn" @click="add_to_cart($event)">
                                        ...
                                        <div class="product-policy">
                                                ...
                                                <div class="product-policy-info">
                                                    ...
                                                    <ul class="list-unstyled">
                                                        @foreach(explode('|', $data->lineBox) as $line_box)
                                                            <li>
                                                                <img data-src="{{asset('html-viettech/images/icon-sidebar-1.png')}}" class="lazyload" alt />{{$line_box}}
                                                            </li>
                                                        @endforeach
                                                    </ul>
                                                </div>
                                            ...
                                            @if(!empty($supports))
                                                        ...
                                                        <div class="d-flex mb-3">
                                                            <div class="avatar">
                                                                @if(!empty($item_sp->avatar_supports))
                                                                    <img src="{{$item_sp->getImageUrl('small')}}" alt="">
                                                                @else
                                                                    <img src="{{asset('html-viettech/images/user.png')}}" alt="">
                                                                @endif
                                                            </div>
                                                            <div class="info-supports">
                                                                ...
                                                                <p>{{$item_sp->email}}</p>
                                                                <span class="w-100 d-flex mt-1"><a style="background: #4267b2" href="{{$item_sp->facebook}}" target="_blank">Facebook</a> &nbsp;<a style="background: #1DA1F2" href="http://zalo.me/{{$item_sp->phone}}" target="_blank">Zalo me!</a></span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                    {{--                                                        <div class="block">--}}
                                                ...
                                                <div class="sp-online border-top-0">
                                                    ...
                                                    <div class="d-flex mb-2 i-f">
                                                        <i class="fa fa-envelope-o fs-20 text-info" aria-hidden="true"></i>:&nbsp;{{$def['email']}}
                                                    </div>
                                                    <div class="d-flex mb-2 i-f">
                ...
                <div class="sidebar-right specifications " id="info_Product_mobile">
                    ...
                    <div class="specifications-desc">
                        ...
                        <div class="view-detail">
                            <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modalSpecificationsMobile">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <ul class="fs-dttsktul list-unstyled" v-for="(item_info_detail, index) in infoPro" style="max-width : 100%;">
            ...
            <div class="tab-product-slider">
                <ul class="tab-control">
                    @if(count($equivalent) > 0)<li><a href="javascipt:;" class="active" data-tab="#tab-1">{{$data->category->title}} tương tự</a></li>@endif
                    @if(count($pro_manu) > 0)<li><a href="javascipt:;" data-tab="#tab-2">{{$data->category->title}} cùng hãng</a></li>@endif
                </ul>
                            ...
                            @foreach($equivalent as $item_equi)
                                <div class="item">
                                    <div class="product-item-2">
                                        <a href="{{route('product.detail', ['alias' => $item_equi->alias])}}" class="wrap-img">
                                            <img src="{{\ImageURL::getImageUrl($item_equi->image, \App\Models\Product::KEY, 'mediumx2')}}" alt="">
                                            {{--                                            <img src="{{asset('upload/products/original/'.$item_equi->image)}}" alt="">--}}
                                        </a>
                                        <div class="body">
                                            <a href="{{route('product.detail', ['alias' => $item_equi->alias])}}" class="name"> {{$item_equi->title}} </a>
                                            ...
                                            @endif
                                            <div class="stars">
                                                <span class="vote"><span class="star" data-vote="{{$item_equi->rate_avg != 0 ? $item_equi->rate_avg : 0}}"></span></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <section class="row main-specifications-wrapper">
                    ...
                    <div id="comment" class="main-wrap comment">
                        ...
                        <div class="box-rating">
                            <div class="box-star text-center clearfix">
                                <div class="point text-center">{{!empty($comment['rating']['avg']) ? $comment['rating']['avg'] : 0}}/5</div>
                                <div class="stars">
                                    <input disabled type="hidden" class="rating" data-filled="star star-filled" data-empty="star star-empty" data-fractions="2" value="{{!empty($comment['rating']['avg']) ? $comment['rating']['avg'] : 0}}"/>
                                </div>
                                ...
                                @for ($i = 5; $i >= 1; $i--)
                                    <div class="box-evaluation-line">
                                        ...
                                        <div class="progress-bar-rating">
                                            <span class="rate-count-show five-star" style="width: @if (!empty($comment['rating']) && isset($comment['rating'])) {{$comment['rating']['rating_'.$i]}}@else 0 @endif%;"></span>
                                        </div>
                            ...
                            <div class="box-send-evaluation text-center">
                                ...
                                <button class="btn">
                                    ...
                                    <img data-src="{{asset('html-viettech/images/icon-arrow.png')}}" class="lazyload" alt />
                                </button>
                            </div>
                        </div>
                        <div class="modal-box-comment">
                            ...
                            <div class="modal-box-content">
                                ...
                                <div class="stars">
                                    ...
                                    <input type="hidden" class="rating" id="rating" name="rating" data-filled="star star-filled" data-empty="star star-empty" data-fractions="2" value="5.0"  />
                                </div>
                                <div class="col-sm-6 mb-3">
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Họ và Tên của bạn">
                                </div>
                                <div class="col-sm-12">
                                    <textarea id="txtNoteRating" name="txtNoteRating" rows="3" class placeholder="Bạn có khuyên người khác mua sản phẩm này không? Tại sao?" ></textarea>
                                </div>
                                ...
                                <div class="actions">
                                    ...
                                    <div class="action-right">
                                        ...
                                        <button type="button" onclick="shop.commentproduct()" class="btn-send">Gửi</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @if($key < 1)
                                            <div class="comment-wrap-detail">
                                                <div class="customer-comment-detail">
                                                    <div class="stars">
                                                        <input disabled type="hidden" class="rating" data-filled="star star-filled" data-empty="star star-empty" data-fractions="2" value="{{$item_comment->rating}}" />
                                                    </div>Bởi : {{$item_comment->name}}
                                                    <img data-src="{{asset('html-viettech/images/icon-tick-green.png')}}" class="lazyload" alt />
                        ...
                        @foreach ($comment['question'] as $key => $item)
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <span>{{$item['question']}}</span> <small class="text-secondary">{{\Lib::dateFormat($item->created, 'd/m/Y - H:i')}}</small>
                                            ...
                                            @if(!empty($item_as['answer']) && !empty($item_as['aid']))
                                                <div class="media mt-3">
                                                    <a class="mr-3 wrap-img" href="javascript:;">
                                                        <img data-src="{{!empty($item_as->user->image) ? $item_as->user->getImageAvatar('small') : asset('html-viettech/images/icon-person.png')}}" class="lazyload" alt="{{$item_as['name']}}" />
                                                    </a>
                                                    <div class="media-body">
                                                        <h5 class="mt-0">
                                                            {{$item_as['name']}}
                                                        ...
                                                        <span>{{$item_as['answer']}}</span> <small class="text-secondary">{{\Lib::dateFormat($item_as->created, 'd/m/Y - H:i')}}</small>
                                                    </div>
                                                </div>
                                            @else
                                                <div class="media mt-3">
                    ...
                    <div class="orther_gallery" id="image">
                        ...
                        <div class="js-carousel" data-items="5" data-dots="false" data-margin="20">
                            @foreach($data->images as $key => $img_item_fo)
                                <div class="item">
                                    <a href="{{\ImageURL::getImageUrl($img_item_fo->image, 'products', 'original')}}" data-fancybox="images-preview">
                                        <img data-src="{{\ImageURL::getImageUrl($img_item_fo->image, 'products', 'original')}}" class="lazyload" alt="">
                                    </a>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="col-md-3">
                    <div class="sidebar">
                        ...
                        <div class="sidebar-right specifications d-none d-md-block" id="info_Product">
                            <div class="title">Thông số kỹ thuật</div>
                            <div class="specifications-desc">
                            ...
                            <div class="compare p-3">
                                ...
                                @foreach($product_compare as $item_compare)
                                    <div class="items same-characteristics">
                                        <div class="image">
                                            <a href="{{route('product.detail', ['alias' => $item_compare->alias])}}" class="thumbnail">
                                                <img data-src="{{\ImageURL::getImageUrl($item_compare->image, 'products', 'small')}}" class="lazyload" alt />
                                            </a>
                                        </div>
                                        <div class="desc">
                                            <a class="link-title" href="{{route('product.detail', ['alias' => $item_compare->alias])}}">{{$item_compare->title}}</a>
                                            <div class="desc-price text-danger">@if($item_compare->out_of_stock == 0){{\Lib::priceFormatEdit($item_compare->price, '')['price']}} đ @else Liên hệ @endif</div>
                                            <div class="parameter">
                                            ...
                                            <div class="link-view">
                                                <a href="{{route('com.product.compare', ['pro_parent' => str_slug($data->title), 'pro_child'=> str_slug($item_compare->title)])}}">Xem so sánh chi tiết</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.main-load-more').each(function () {
                $(this).find('.load').slice(0, 2).show();
                if($(this).find('.load').length <= 2){
